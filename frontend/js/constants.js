const contractAddress = "0xa2b7A2b1F678d4429534d63BE468e4Cf313f03ef"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the DummyMummyClub NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The DummyMummyClub NFT Project is a decentralized, community based and charity oriented project, that aims to make the world a bit better place, and your day bit brighter.';
